class RotaryEncoder:
    ...
    def __init__(self, clk_GPIO, dt_GPIO, switch_GPIO,  min_counter, max_counter, back_to_front, call_back=None):
        ...
        self.GPIO.add_event_detect(self.clk, self.GPIO.FALLING, callback=self.check_rotary_state)
        self.GPIO.add_event_detect(self.dt, self.GPIO.FALLING, callback=self.check_rotary_state)
